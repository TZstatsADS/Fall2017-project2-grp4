...
shinyServer = function(input, output, session) {
  ...
  output$map = renderLeaflet({
    leaflet() %>% addTiles() %>%
      ...
      addMarkers(icon = iconList(freq = makeIcon("../../../data/subway_icon.png", iconWidth = 20, iconHeight = 20)), 
...
<<<<<<< HEAD:lib/Final_v2/server.R
=======
  #output$Overview = renderText({
    #paste("<b>","The purpose of this project is ...")
  #})
  
>>>>>>> e8e0253fca7b8b7021ada25c2b7baf8f371cdfb0:lib/New/Final_v2/server.R
